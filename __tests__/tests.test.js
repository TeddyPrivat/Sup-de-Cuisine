const { filterList, filterRecettes } = require('../scripts/index.js');
...
let searchTerm = "poulet";
test('filtrage des recettes, on devrait trouver la recette : Poulet coco réunionais', () => {
  expect(filterRecettes(recettes, searchTerm).toBe([{
    "id": 3,
    "image": "Recette03.jpg",
    "name": "Poulet coco réunionnais",
    "servings": 4,
